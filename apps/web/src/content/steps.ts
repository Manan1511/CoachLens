...
export const STEPS: Step[] = [
  ...
  },
  {
    ...
    desc: 'Drop the clips into your browser, from the pavilion or from home. We check each one is usable before analysing it — steady frame rate, no motion blur, bowler clearly visible. Unusable clips get flagged, not guessed at.',
  },
  {
    number: '04',
    label: 'Step 04',
